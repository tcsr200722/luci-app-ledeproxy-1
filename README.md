## 整理声明：
ledeproxy是基于koolproxy重新整理而来。主要参考：

1、以前Ameykyl大神的[KoolProxyR Plus+](https://github.com/Ameykyl/luci-app-koolproxyR) (源码已经2020年月删除）。源码来源于[project-openwrt](https://github.com/project-openwrt/luci-app-koolproxyR)收录的ameykyl的2020年3月最后一次更新。 

2、[baozi大神](https://github.com/Baozisoftware/luci-app-koolproxy) koolproxy。

3、[shaoxia](https://github.com/user1121114685/koolproxyR) koolproxyR。

4、文件目录主要参考[Beginner-Go](https://github.com/Beginner-Go/luci-app-koolproxyR)。

5、感谢koolproxy官方组、baozi、shaoxia、Ameykyl、project-openwrt组、Beginner-Go等的无私奉献！

6、规则来源于[ledeproxy](https://github.com/ledewrt/LedeProxy) 致谢[ycg31](https://github.com/ycg31/KoolProxy)。
